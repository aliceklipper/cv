/**
 * @file Alice Klipper's CV, ESLint config.
 * @author Alice Klipper <alice.klipper@yandex.com> (https://t.me/aliceklipper)
 * @license MIT
...
module.exports = {
    ...
    plugins: ['flowtype', 'react', 'prettier', 'babel', 'import', 'eslint-comments', 'promise', 'filenames', 'fp', 'security', 'unicorn', 'flowtype-errors'],
    rules: {
        ...
        'filenames/match-regex': [ERROR, '^[A-Za-z\\-.]+|__$', true],
    ...
    settings: {
        'import/resolver': {
            webpack: {
                config: join(process.cwd(), 'webpack.config.js'),
            },
        },
        // 'import/extensions': ['.js', '.jsx', '.json'],
        // 'import/core-modules': ['~', 'actions', 'api', 'components', 'config', 'containers', 'lib', 'messages', 'store', 'types'],
    },
};
